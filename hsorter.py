...
class HSorterWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, app: Gtk.Application, db: Database) -> None:
        ...
        self.settings_path = os.path.join(os.path.dirname(__file__), "hsorter_settings.json")
    ...
    def _load_window_settings(self) -> None:
        ...
        if isinstance(data.get("window_size"), list) and len(data["window_size"]) == 2:
            self.resize(data["window_size"][0], data["window_size"][1])
        if isinstance(data.get("main_paned_pos"), int):
            self.main_paned.set_position(data["main_paned_pos"])
        if isinstance(data.get("right_paned_pos"), int):
            self.right_paned.set_position(data["right_paned_pos"])
    ...
    def _save_window_settings(self, *_args) -> None:
        ...
        data = {
            ...
            "main_paned_pos": self.main_paned.get_position(),
            "right_paned_pos": self.right_paned.get_position(),
        }
        try:
